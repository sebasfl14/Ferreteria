...
public class UsuarioMySqlRepositorio implements UsuarioRepositorio {
	...
	public int actualiza(Usuario obj) {
		...
		return jdbcTemplate.update("update usuario set nombre =?, apellido =?, usuario =?, contrase�a =?, email =? where idUsuario =? ", new Object[] { obj.getNombre(), obj.getApellido(), obj.getUsuario(), obj.getContraseña(),obj.getIdUsuario(), obj.getEmail()});
	}
